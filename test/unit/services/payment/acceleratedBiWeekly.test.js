...
describe('Accelerated Bi-Weekly Payment Strategy', () => {
  it('should return exactly half of the monthly payment', () => {
    ...
    const payment = acceleratedBiWeekly.calculate(principal, annualInterestRate, amortizationYears);
    
    expect(monthly.calculate).toHaveBeenCalledWith(principal, annualInterestRate, amortizationYears);
